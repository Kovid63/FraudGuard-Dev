...
// Full-screen failure message component
  ...
  <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
    <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8 text-center">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Maximum verification attempts exceeded. You cannot try again for this order.</p>
      </div>
    </div>
  </div>
);
...
const CreditCardCrop = () => {
  ...
  const [hasVerificationFailed, setHasVerificationFailed] = useState(false); // Track if verification has failed at least once
  ...
  // If form is disabled (max attempts exceeded), show full-screen failure
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setHasVerificationFailed(true); // Mark that verification has failed at least once
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
        ...
        {!modalOpen && (
          <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-6 sm:p-8 flex flex-col items-center">
            ...
            {/* Only show OCR result if verification has failed at least once */}
            {ocrResult && hasVerificationFailed && (
            ...
            <div className="w-full flex flex-col items-center mt-6">
              <button
                ...
                disabled={!ocrResult?.last4 || !selectedCountry || verifyLoading}
