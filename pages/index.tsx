  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      try {
        ...
        // Optionally, set active link dynamically:
        navigationMenu.set({ active: dashboardLink });

        console.log('Navigation menu created successfully');
      } catch (error) {
        console.error('Error creating navigation menu:', error);
        // Silently fail - navigation menu is not critical for app functionality
      }
    }, 100);
